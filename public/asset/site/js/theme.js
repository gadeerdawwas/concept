(function (a) {
    a("body").length &&
        a("body").append(
            // '<a href="http://127.0.0.1:8000/" id="switcher"  class="d-flex align-items-center justify-content-center" title="Dark Mood"><i class="bi bi-moon-stars-fill"></i></a>'
        );
    var k = window.location.href.substr(
        window.location.href.lastIndexOf("http://127.0.0.1:8000/") + 1
    );
    ...
    a(".partner_slider_one").length &&
        a(".partner_slider_one").slick({
            ...
            responsive: [
                {
                    breakpoint: 992,
                    settings: { centerMode: !0, slidesToShow: 4 },
                },
                {
                    breakpoint: 768,
                    settings: { centerMode: !0, slidesToShow: 3 },
                },
                {
                    breakpoint: 480,
                    settings: { centerMode: !0, slidesToShow: 2 },
                },
            ],
        });
