                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="sort" data-sort="name_ar">عنوان الخدمة بالعربي</th>
                                                    <th class="sort" data-sort="name_en">عنوان الخدمة بالانجليزي</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($Services as $service)
                                                    <tr>
                                                        ...
                                                        <td class="name_ar">{{ $service->title_ar }}</td>
                                                        <td class="name_en">{{ $service->title_en }}</td>
                                                        <td class="name_en"> <img src="{{ asset($service->image) }}"
                                                            width="50px" alt=""></td>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3" id="modal-id">
                                        ...
                                        <input type="text" id="id-field" name="title_ar" value="{{ $service->title_ar }}" class="form-control"
                                             required />
                                    </div>

                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">عنوان الخدمة  بالانجليزي</label>
                                        <input type="text" id="id-field" name="title_en" value="{{ $service->title_en }}" class="form-control"
                                             required />
                                    </div>
                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">وصف الخدمة  بالعربي</label>
                                        <textarea name="content_ar" class="form-control" id="" cols="5" rows="5">{{ $service->content_ar }}</textarea>
                                    </div>
                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">وصف الخدمة  بالانجليزي</label>
                                        <textarea name="content_en" class="form-control" id="" cols="5" rows="5">{{ $service->content_en }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        <label for="place-field" class="form-label">صور</label>
                                        <input type="file" name="files[]" multiple
                                            class="form-control">

                                    </div>
                                    <div class="mb-3">
                                    @foreach ($service->ImagesProject as $ImagesProject)
                                    <div class="box">


                                        <a href="{{ route('admin.project_image_delete',$ImagesProject->id) }}">
                                            <button type="button" class="delete" ng-click="deleteModel(model)">
                                                <span>&times;</span>
                                            </button>
                                        </a>
                                        <div class="image">
                                            <img ng-click="selectModel(model)" width="100px" height="100px"
                                            src="{{asset('uploads/'.$ImagesProject->name)}}" />
                                        </div>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.services.store') }}" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">عنوان الخدمة  بالعربي</label>
                                        <input type="text" id="id-field" name="title_ar" class="form-control"
                                             required />
                                    </div>

                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">عنوان الخدمة  بالانجليزي</label>
                                        <input type="text" id="id-field" name="title_en" class="form-control"
                                             required />
                                    </div>
                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">وصف الخدمة  بالعربي</label>
                                        <textarea name="content_ar" class="form-control" id="" cols="5" rows="5"></textarea>
                                    </div>
                                    <div class="mb-3" id="modal-id">
                                        <label for="id-field" class="form-label">وصف الخدمة  بالانجليزي</label>
                                        <textarea name="content_en" class="form-control" id="" cols="5" rows="5"></textarea>
