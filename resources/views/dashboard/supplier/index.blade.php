                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">الموردين </h4>
                            </div><!-- end card header -->
                                        ...
                                        <div class="col-sm-auto">
                                            <div>
                                                <button type="button" class="btn btn-success add-btn"
                                                    ...
                                                    <i class="ri-add-line align-bottom me-1"></i> إضافة مورد </button>
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($Suppliers as $Supplier)
                                                    <tr>
                                                        ...
                                                        <td class="name_en"> <img src="{{ asset($Supplier->name) }}"
                                                                width="50px" alt=""></td>
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                <div class="remove">
                                                                    <button class="btn btn-sm btn-danger remove-item-btn"
                                                                        ...
                                                                        data-bs-target="#deleteRecordModal{{ $Supplier->id }}">حذف</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <div class="modal fade zoomIn"
                                                            id="deleteRecordModal{{ $Supplier->id }}" tabindex="-1"
                                                            aria-hidden="true">
