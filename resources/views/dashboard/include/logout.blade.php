<!DOCTYPE html>
<html lang="en" dir="rtl" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Feb 2022 20:25:06 GMT -->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <img id="header-lang-img" src="dashboard/assets/images/flags/us.svg"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="dashboard/assets/images/flags/us.svg" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="dashboard/assets/images/flags/spain.svg" alt="user-image"
                                        class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="dashboard/assets/images/flags/germany.svg" alt="user-image"
                                        class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="dashboard/assets/images/flags/italy.svg" alt="user-image"
                                        class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="dashboard/assets/images/flags/russia.svg" alt="user-image"
                                        class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="dashboard/assets/images/flags/china.svg" alt="user-image"
                                        class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="dashboard/assets/images/flags/french.svg" alt="user-image"
                                        class="me-2 rounded" height="18" />
                            ...
                            <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="dashboard/assets/images/brands/bitbucket.png"
                                                    alt="bitbucket" />
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="dashboard/assets/images/brands/dribbble.png"
                                                    alt="dribbble" />
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="dashboard/assets/images/brands/dropbox.png"
                                                    alt="dropbox" />
                                                <span>Dropbox</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="dashboard/assets/images/brands/mail_chimp.png"
                                                    alt="mail_chimp" />
                                ...
                                <div class="tab-content" id="notificationItemsTabContent">
                                    ...
                                    <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel"
                                        ...
                                        <div class="w-25 w-sm-50 pt-3 mx-auto">
                                            <img src="dashboard/assets/images/svg/bell.svg" class="img-fluid"
                                                alt="user-pic" />
                                        </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Feb 2022 20:26:51 GMT -->
